...
from celatlas_spatial.tools.spatial_mkref import Mkref, super_opts
...
class Mkref_rna(Mkref):
    ...
    ## Usage
    ```
    celatlas_spatial utils mkgtf Homo_sapiens.GRCh38.99.gtf Homo_sapiens.GRCh38.99.filtered.gtf
    ...
    - Genome config file
    ```
    $ cat celatlas_spatial_genome.config
    [genome]
