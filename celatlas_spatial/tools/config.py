...
from celatlas_spatial.__init__ import ROOT_PATH
...
def update_config(config, cfg_path):
...
def get_config():
    ...
    config = _C.clone()
    update_config(config, cfg_path=f'{ROOT_PATH}/configs/swin_tiny_patch4_window7_224_lite.yaml')
