...
import celatlas_spatial.tools.emptydrop_cr.sgt as cr_sgt  # # modified sgt.py
import celatlas_spatial.tools.emptydrop_cr.stats as cr_stats  # # modified stats.py
